...
<div style="padding: 7em">
    <section>
        ...
        <p>Дизайн студия <strong class="aristo"><i><?= Yii::$app->params['company'] ?></i></strong> работает на рынке
            дизайнерских услуг в Чувашской республике и г. Чебоксары с 2014 года.<br/>
            Мы гарантируем Вам весь необходимый цикл работ начиная от идеи и заканчивая предоставлением всех необходимых
            качественно выполненных эскизов.
            Наш основной вид деятельности &mdash; <strong>Дизайн экстерьера и интерьера.</strong>.</p>
        <p>

        </p>

        <p>Качество продукции от компании <strong class="aristo"><i><?= Yii::$app->params['company'] ?></i></strong>
            подкреплено многолетними наработками европейских компаний на рынке мебельных, стеллажных систем и фурнитуры.
        </p>
