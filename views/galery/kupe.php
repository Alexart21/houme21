...
$this->title = 'Дизайн шкафа купе и раздвижных систем в Чебоксарах от ' . Yii::$app->params['company'] . $page;
...
<div class="galery-small">
    <h1 class="header_shadow center-text wow bounceInDown" data-wow-delay="0.5s">Дизайн шкафа купе и разджвижных систем
        от <i><?= Yii::$app->params['company'] ?></i></h1>
    <?php
    $delay = 0.1;
    ?>
