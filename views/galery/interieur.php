...
$this->title = 'Дизайн интерьера в Чебоксарах от ' . Yii::$app->params['company'] . $page;
...
<div class="galery-small">
    <h1 class="header_shadow center-text wow bounceInDown" data-wow-delay="0.5s">Дизайн интерьера от
